...
byte DiceAccelerator::init(MMA8452Q_Scale fsr, MMA8452Q_ODR odr)
{
...
byte DiceAccelerator::available()
{
...
void DiceAccelerator::setScale(MMA8452Q_Scale fsr)
{
...
void DiceAccelerator::setODR(MMA8452Q_ODR odr)
{
	// Must be in standby mode to make changes!!!
...
//			on that axis.
void DiceAccelerator::setupTap(byte xThs, byte yThs, byte zThs)
{
...
void DiceAccelerator::writeRegister(MMA8452Q_Register reg, byte data)
{
